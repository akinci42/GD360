...
const NAV_ITEMS = [
  { key: 'dashboard', path: '/dashboard', roles: ['owner', 'coordinator', 'sales', 'viewer'] },
  ...
  { key: 'offers', path: '/offers', roles: ['owner', 'coordinator', 'sales', 'viewer'] },
  { key: 'orders', path: '/orders', roles: ['owner', 'coordinator', 'sales', 'viewer'] },
  { key: 'products', path: '/products', roles: ['owner', 'coordinator', 'sales', 'viewer'] },
  { key: 'reports', path: '/reports', roles: ['owner', 'coordinator', 'viewer'] },
  { key: 'calendar', path: '/calendar', roles: ['owner', 'coordinator', 'sales', 'viewer'] },
  { key: 'messages', path: '/messages', roles: ['owner', 'coordinator', 'sales'] },
  { key: 'settings', path: '/settings', roles: ['owner', 'coordinator', 'sales', 'viewer'] },
