...
const USERS = [
  {
    email: 'remzi@gencdegirmen.com.tr',
  ...
  },
  {
    ...
    full_name: 'Orhan Güler',
    role: 'sales',
    level: 2,
    region: 'Türkiye',
  },
  {
    email: 'sinan@gencdegirmen.com.tr',
  ...
  {
    email: 'ramazan@gencdegirmen.com.tr',
    full_name: 'Ramazan Topaç',
    role: 'sales',
    level: 2,
    region: 'Özbekistan, Kazakistan, Rusya, Azerbaycan, Tacikistan, Ukrayna',
  },
  {
    email: 'sanzhar@gencdegirmen.com.tr',
  ...
  {
    email: 'sami@gencdegirmen.com.tr',
    full_name: 'Sami Elşeyh',
    role: 'sales',
    level: 2,
    region: 'Mısır, Libya, Sudan, Irak, Yemen, İran, Cezayir, Fas',
  },
  {
    email: 'isa@gencdegirmen.com.tr',
    full_name: 'İsa Akıncı',
    role: 'viewer',
    level: 1,
